                        ...
                        <ul class="dropdown-menu dropdown-menu-end" style="background-color: #12372a"
                            ...
                            <li>
                                <a class="dropdown-item text-secondary" href="{{ route('Admin.logout') }}"
                                    data-name="{{ Auth::guard('admin')->user()->nama_lengkap }}"
                                    id="Logout">Logout</a>
                            </li>
                        </ul>
                    </div>
                @else
                    @guest
                        <ul class="navbar-nav mb-2 mb-lg-0 px-2">
                            ...
                            <li class="nav-item mx-2">
                                <a class="nav-link @yield('register') " href="{{ url('register') }}">Register</a>
                            </li>
                            <li class="nav-item mx-2">
                    ...
                    @auth('web')
                        ...
                        <div class="dropdown p-1 pb-2 mx-4">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" style="background-color: #12372a"
                                ...
                                <li>
                                    <a class="dropdown-item text-secondary" href="{{ route('logout') }}" id="Logout"
                                        data-name="{{ Auth::User()->nama_depan }} {{ Auth::User()->nama_belakang }}">Logout</a>
                                </li>
                            </ul>
                        </div>
                    @endauth
